...
const App: React.FC = () => {
  ...
  return (
    <motion.div 
        ...
        className="min-h-screen text-white font-sans pb-24" style={{background:"#08080c"}}
    >
      ...
      {activeTab === 'home' && (
        <header className={`fixed top-0 inset-x-0 z-50 px-4 py-4 flex justify-between items-center transition-all duration-300 ${!isNavVisible ? 'bg-black/80 backdrop-blur-xl border-b border-white/5 py-3 shadow-lg' : 'bg-gradient-to-b from-black/90 to-transparent'}`}>
            ...
            <motion.div 
              ...
              className="font-brand text-4xl tracking-wide text-transparent bg-clip-text bg-gradient-to-r from-gold via-white to-gold cursor-pointer drop-shadow-[0_2px_12px_rgba(220,180,60,0.4)] select-none"
            ...
            <div className="flex items-center gap-3">
                ...
                <button 
                  ...
                  className="w-10 h-10 rounded-full bg-gradient-to-br from-gold/10 to-gold2/10 backdrop-blur-md flex items-center justify-center border border-gold/20 active:scale-95 transition-all text-gold"
                >
                    <Sparkles size={18} />
                </button>
            </div>
      ...
      <main className={`px-4 max-w-7xl mx-auto relative z-10 ${activeTab === 'home' ? '-mt-2' : 'pt-20'}`}>
        ...
        {activeTab === 'home' && (
            <>  
                ...
                <div className="sticky top-[60px] z-30 bg-[#08080c]/95 backdrop-blur-xl -mx-4 px-4 py-4 mb-6 border-b border-white/5">
                               ...
                               >
                                   {isActive && (
                                       <motion.div 
                                          ...
                                          className="absolute inset-0 bg-gradient-to-r from-gold to-gold2 rounded-xl z-0"
                ...
                <div className="pb-8">
                    <h3 className="mb-4 flex items-center gap-2" style={{fontFamily:"'Outfit',sans-serif",fontSize:'18px',fontWeight:700,color:'#fff',letterSpacing:'-0.01em'}}>
                        <span className="w-1 h-5 bg-gold rounded-full shadow-[0_0_10px_rgba(220,180,60,0.6)]"></span>
